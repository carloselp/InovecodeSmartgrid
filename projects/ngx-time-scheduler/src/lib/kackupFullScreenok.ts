...
// })
// export class NgxTimeSchedulerBackupComponent implements OnInit, OnDestroy {
//   nativeElement: NgxTimeSchedulerBackupComponent | undefined;
...
//   toggleFullscreen() {
//     const elem = this.schedulerContainer.nativeElement;
//     const modalElement = document.querySelector('.mat-dialog-container');
//     if (modalElement) {
//       document.body.appendChild(modalElement);  // Mover para o body ou outro elemento
//     }
//     // Se o navegador não estiver em tela cheia, tenta entrar em tela cheia
//     if (!document.fullscreenElement) {
...
//       }
//     } else {
//       // Caso já esteja em tela cheia, sai do modo
